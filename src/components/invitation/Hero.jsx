  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-10 bg-cream px-6 overflow-hidden">
      ...
      {guestName && (
        ...
        >
          <span className="text-[10px] uppercase tracking-[0.5em] text-gold/60 font-bold mb-1 block">A Special Welcome to Our Guest</span>
      ...
      >
        ...
        <p className="text-[10px] md:text-[12px] uppercase tracking-[0.6em] font-montserrat font-medium text-gold/80">The Wedding Invitation of</p>
      </motion.div>
      ...
      >
        <p className="text-lg md:text-xl font-cormorant italic text-gold mb-6 tracking-[0.2em]">Are embarking on a new journey together</p>
          ...
          <div key={unit} className="flex flex-col items-center">
             <div className="relative group">
                <div className="w-16 h-16 md:w-24 md:h-24 rounded-full border border-gold/10 flex flex-col items-center justify-center bg-white/40 shadow-[0_10px_30px_rgba(0,0,0,0.03)] backdrop-blur-md transition-all duration-500 group-hover:border-gold/30">
                   <span className="text-xl md:text-3xl font-serif text-deep-green font-light">{value}</span>
                   <span className="text-[8px] md:text-[9px] uppercase tracking-widest text-gold/60 mt-1 font-bold">{unit}</span>
                </div>
                {/* Decorative ring */}
      ...
      >
        <span className="text-[8px] uppercase tracking-[0.8em] text-gold font-bold">Scroll</span>
